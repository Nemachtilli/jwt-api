...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="productos">
                    <a href="#productos">Productos</a>
                                    ...
                                    <ul id="tocify-subheader-productos" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="productos-GETapi-products">
                        <a href="#productos-GETapi-products">Productos paginados</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productos-POSTapi-products">
                        <a href="#productos-POSTapi-products">Crear producto</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productos-GETapi-products--id-">
                        <a href="#productos-GETapi-products--id-">Obtener producto por ID</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productos-PUTapi-products--id-">
                        <a href="#productos-PUTapi-products--id-">Actualizar producto</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productos-DELETEapi-products--id-">
                        <a href="#productos-DELETEapi-products--id-">Eliminar producto por ID</a>
                    </li>
                                                    </ul>
                            </ul>
        ...
        <li>Last updated: July 19 2022</li>
    </ul>
</div>
...
<p>Api de prueba de aprendizaje</p>
<pre><code>Información acerca de la API
...
Puede cambiar el idioma utilizado con las pestañas en la parte superior derecha (o desde el menú de navegación en la parte superior izquierda en el móvil).&lt;/aside&gt;</code></pre>
<blockquote>
<p>Base URL</p>
</blockquote>
...
<p>Puedes obtener el Token de acceso en tu cuenta desde la API</p>
...
<form id="form-POSTapi-auth-login" data-method="POST"
    ...
    <br>
<p>Un correo electrónico válido y que exista en base de datos</p>
        </p>
                <p>
...
<form id="form-POSTapi-auth-logout" data-method="POST"
    ...
    <h3>
        ...
        <h1 id="productos">Productos</h1>
            ...
            <h2 id="productos-GETapi-products">Productos paginados</h2>
...
<div class="bash-example">
    ...
    --get "http://127.0.0.1:8000/api/products?page=13" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<form id="form-GETapi-products" data-method="GET"
    ...
    <br>
            ...
            <h2 id="productos-POSTapi-products">Crear producto</h2>
...
<p>Precio del producto</p>
            ...
            <h2 id="productos-GETapi-products--id-">Obtener producto por ID</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/products/9" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
url = 'http://127.0.0.1:8000/api/products/9'
headers = {
  'Authorization': 'Bearer {YOUR_AUTH_KEY}',
  'Content-Type': 'application/json',
  'Accept': 'application/json'
...
<p>ID del producto</p>
            ...
            <h2 id="productos-PUTapi-products--id-">Actualizar producto</h2>
...
<p>Precio del producto</p>
            ...
            <h2 id="productos-DELETEapi-products--id-">Eliminar producto por ID</h2>
